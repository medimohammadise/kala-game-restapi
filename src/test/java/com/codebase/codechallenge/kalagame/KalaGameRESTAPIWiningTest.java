...
/*
  This class aim to test one player round for win! It is time consuming to play manually always so I'm asking Junit to play and check in behalf of me!
 */
@RunWith(SpringRunner.class)
@SpringBootTest
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
@Transactional
public class KalaGameRESTAPIWiningTest {
